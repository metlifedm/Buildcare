...
export default function Portfolio() {
  ...
  return (
    <>
      ...
      <section className="py-24 bg-dark-950" aria-label="Project gallery">
        <div className="container-custom">
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      {/* Hover Overlay */}
                      <div className="absolute inset-0 bg-gradient-to-t from-dark-950/90 via-dark-950/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-5 transform translate-y-6 group-hover:translate-y-0 transition-transform duration-500">
                        <span className="inline-block px-3 py-1 rounded-full bg-primary-400/20 text-primary-300 text-xs font-medium mb-2 backdrop-blur-sm">
                          {project.category}
                        </span>
                        <h3 className="font-heading text-lg font-semibold text-white mb-1">
                          {project.title}
                        </h3>
                        <div className="flex items-center gap-3 text-dark-300 text-xs">
                      ...
                      {/* Expand Icon */}
                      <div className="absolute top-4 right-4 w-10 h-10 rounded-full glass flex items-center justify-center opacity-0 group-hover:opacity-100 scale-75 group-hover:scale-100 transition-all duration-300">
          ...
          {filteredProjects.length === 0 && (
            <motion.p
              className="text-center text-dark-400 py-20 text-lg"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            >
      ...
      <AnimatePresence>
        {lightboxIndex !== null && filteredProjects[lightboxIndex] && (
          <motion.div
            className="fixed inset-0 z-[100] flex items-center justify-center bg-dark-950/95 backdrop-blur-md"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          ...
          >
            ...
            <button
              onClick={closeLightbox}
              className="absolute top-6 right-6 z-10 w-12 h-12 rounded-full glass flex items-center justify-center text-white hover:text-primary-400 transition-colors cursor-pointer"
            ...
            <button
              ...
              className="absolute left-4 md:left-8 top-1/2 -translate-y-1/2 z-10 w-12 h-12 rounded-full glass flex items-center justify-center text-white hover:text-primary-400 transition-colors cursor-pointer"
            ...
            <button
              onClick={(e) => { e.stopPropagation(); navigateLightbox(1); }}
              className="absolute right-4 md:right-8 top-1/2 -translate-y-1/2 z-10 w-12 h-12 rounded-full glass flex items-center justify-center text-white hover:text-primary-400 transition-colors cursor-pointer"
            ...
            >
              ...
              <div className="mt-6 text-center">
                ...
                <p className="text-dark-200 mb-3 max-w-2xl mx-auto">
                  {filteredProjects[lightboxIndex].description}
                </p>
                <div className="flex items-center justify-center gap-6 text-dark-300 text-sm">
                  <span className="flex items-center gap-1">
              ...
              <div className="text-center mt-3 text-dark-500 text-sm">
