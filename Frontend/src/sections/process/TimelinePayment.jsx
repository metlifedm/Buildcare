      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-medium text-primary-700">Financial Transparency</span>
          </motion.div>

          <h2 className="text-4xl md:text-5xl font-heading font-bold mb-6">
            Timeline & <span className="text-primary-600">Payment</span> – No Surprises
          </h2>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-3xl overflow-hidden border border-gray-200 shadow-sm">
            ...
            <div className="grid grid-cols-12 gap-4 p-6 bg-gray-50 border-b border-gray-200">
              ...
              <div className="col-span-4 text-center">
                <span className="font-semibold text-primary-700">Duration</span>
              </div>
            ...
            {stages.map((stage, index) => (
              <motion.div
                ...
                className={`grid grid-cols-12 gap-4 p-6 border-b border-gray-100 last:border-0 hover:bg-gray-50 transition-all duration-300 group`}
              >
                <div className="col-span-5 flex items-center gap-3">
                  <div className={`w-10 h-10 rounded-xl bg-primary-50 flex items-center justify-center group-hover:scale-110 transition-transform`}>
                    <stage.icon className={`w-5 h-5 text-primary-600`} />
                  </div>
          ...
          <motion.div
            ...
            className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 p-6 rounded-2xl bg-primary-50 border border-primary-200"
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-semibold text-primary-700 text-lg">✅ No surprise cost guarantee</div>
                <p className="text-sm text-primary-600">100% transparent pricing, no hidden fees</p>
              </div>
            </div>
          </motion.div>
        </div>
